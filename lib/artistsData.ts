...
export const ARTISTS: Artist[] = [
  {
    ...
    works: [
      { src: '/imagens-junco/tattoo-15.webp', alt: 'Fechamento de braço com leão e rosto de Jesus fundidos em realismo preto e cinza' },
      { src: '/imagens-junco/tattoo-16.webp', alt: 'Tatuagem de estátua grega de Zeus em realismo preto e cinza' },
      { src: '/imagens-junco/tattoo-17.webp', alt: 'Fechamento de braço com leão, cruz, relógio e bússola em realismo' },
      { src: '/imagens-junco/tattoo-18.webp', alt: 'Tatuagem de Jesus Cristo com coroa de espinhos e cruz em realismo' },
      { src: '/imagens-junco/tattoo-20.webp', alt: 'Tatuagem de armadura de cavaleiro com espada em realismo' },
      { src: '/imagens-junco/tattoo-21.webp', alt: 'Tatuagem de guerreiro com elmo e espada em realismo' },
      { src: '/imagens-junco/tattoo-26.webp', alt: 'Tatuagem de rosto feminino com cruz em realismo até a mão' },
      { src: '/imagens-junco/tattoo-27.webp', alt: 'Tatuagem hiper-realista de lata de energético na mão' },
    ],
  },
  {
    slug: 'apollo',
